...
$loggedIn = array(array("link"=>"href=/user/editor","text"=>"Editor"),array("link"=>"onclick='logout()'","text"=>"Logout"),array("link"=>"onclick='copy()'","hide"=>True,"text"=>"Copy"));
...
require("gen/quick.php");

}else if($url == "/u"){

require("gen/user.php");
